...
namespace Vy
{
	...
	{
		VY_INFO_TAG("CameraController", "Initialized");
	...
	void CameraController::toggleMouseRotate(bool bEnabled)
	{
		...
		if (!m_MouseRotateEnabled && bEnabled)
		{
		...
		else if (m_MouseRotateEnabled && !bEnabled)
		{
