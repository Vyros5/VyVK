...
namespace Vy
{
    ...
    public:
        ...
        public:
             ...
             */
			VY_NODISCARD
			Unique<VyDescriptorPool> buildPtr() const;
        ...
        */
         ...
         *
         * @param allocInfo  Allocation info for the descriptor set.
         * @param descriptors Output vector to hold the allocated descriptor sets.
         * 
        ...
        /**
         * @brief Allocates multiple descriptor sets from the pool.
         *
         * @param setLayout   Layout used for the descriptor sets.
         * @param descriptors Output vector to hold the allocated descriptor sets.
         * @param pNext       Optional pointer for extended allocation info (default: nullptr).
         * 
         * @return true if allocation succeeded; false if the pool is out of memory or fragmented.
         ...
         * @brief Allocates multiple descriptor sets from the pool.
         *
         * @param pSetLayouts  Array of layouts used for the descriptor sets.
         * @param descriptors  Output vector to hold the allocated descriptor sets.
         * @param pNext        Optional pointer for extended allocation info (default: nullptr).
         * 
         * @return true if allocation succeeded; false if the pool is out of memory or fragmented.
        ...
        TVector<VkDescriptorSet> allocateSets(const VyDescriptorSetLayout& layout, const U32 count);
    ...
    private:
        ...
        bool checkResult(VkResult result) const;
