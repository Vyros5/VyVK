...
{ // C:\dev\Engine\Vy\Source\Vy\Globals.h
	...
	// namespace Utils
	// {
	// 	TString engineDirectoryString(TString path) 
	// 	{
	// 		return ( ENGINE_DIR + path );
	// 	}

	// 	TString engineDirectory(const char* path) 
	// 	{
	// 		return TString( ENGINE_DIR ).append( path );
	// 	}

	// 	TString assetDirectory(const char* path) 
	// 	{
	// 		return TString( ASSETS_DIR ).append( path );
	// 	}
	// }
}