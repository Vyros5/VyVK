...
namespace Vy
{
    ...
    VyRenderSystem::VyRenderSystem(VkRenderPass renderPass, TVector<VkDescriptorSetLayout> setLayouts, VyDescriptorPool& descriptorPool)
    {
    ...
    void VyRenderSystem::renderCascadedShadowPass(VyFrameInfo frameInfo, GlobalUbo& globalUBO)
    {
    ...
    void VyRenderSystem::renderPointShadowPass(VyFrameInfo frameInfo, GlobalUbo& globalUBO)
    {
        // PROFILE_FUNCTION();
    ...
    void VyRenderSystem::renderMainPass(VyFrameInfo frameInfo)
    {
        ...
        TVector<VkDescriptorSet> globSet = { 
            frameInfo.GlobalSet, 
            m_CascadedShadowPassDescriptorSet, 
            m_CascadedShadowMapDescriptorSet,
    ...
    void VyRenderSystem::renderObjects(VyFrameInfo frameInfo, PushConstantType type, int setCount, bool bRenderMaterial)
    {
        ...
        for (auto&& [ entity, modelComp, transform ] : view.each())
        {
            ...
            else if(type == VyRenderSystem::POINTSHADOW)
            {
            ...
            else if (type == VyRenderSystem::SPOTSHADOW)
            {
            ...
            else if (type == VyRenderSystem::CASCADEDSHADOW)
            {
    ...
    void VyRenderSystem::createPipeline(VkRenderPass renderPass, TVector<VkDescriptorSetLayout> setLayouts, VyDescriptorPool& descriptorPool)
    {
        TVector<VkDescriptorSetLayout> mainSetLayouts;
        TVector<VkDescriptorSetLayout> shadowPassSetLayouts;
        ...
        {
            cascadedshadowMapDescriptor.sampler     = m_CascadedDepthMapObject.Sampler.handle();
            cascadedshadowMapDescriptor.imageView   = m_CascadedDepthMapObject.View.handle();
        ...
        // Main Pipeline
        {
            ...
            builder.addShaderStage(VK_SHADER_STAGE_VERTEX_BIT,   "Basic.vert.spv");
            builder.addShaderStage(VK_SHADER_STAGE_FRAGMENT_BIT, "Basic.frag.spv");
    ...
    void VyRenderSystem::prepareShadowPassRenderpass()
    {
    ...
    void VyRenderSystem::prepareShadowPassUBO()
    {
        // Cascaded Shadow Map
    ...
    void VyRenderSystem::updateShadowPassBuffer(GlobalUbo& globalUBO)
    {
    ...
    void VyRenderSystem::prepareCascadeShadowPass()
    {
        ...
        m_CascadedDepthMapObject.Image = dImgBuilder.build();
        ...
        m_CascadedDepthMapObject.View = dViewBuilder.build( m_CascadedDepthMapObject.Image );
        ...
        for (U32 i = 0; i < CASCADE_SHADOW_MAP_COUNT; i++) 
        {
            ...
            m_CascadedShadowPass.Cascades[ i ].View = cascadeBuilder.build( m_CascadedDepthMapObject.Image );
    ...
    void VyRenderSystem::updateCascades(GlobalUbo& globalUBO)
    {
    ...
    void VyRenderSystem::preparePointShadowCubeMaps()
    {
    ...
    void VyRenderSystem::preparePointShadowPassRenderPass()
    {
        TVector<VkAttachmentDescription> attachments{};
        {
            // [ Color - 0 ] 
    ...
    void VyRenderSystem::preparePointShadowPassFramebuffers()
    {
    ...
    void VyRenderSystem::updateCubeFace(U32 faceIndex, VyFrameInfo frameInfo, GlobalUbo& globalUBO)
    {
    ...
    void VyRenderSystem::prepareSpotShadowMaps()
    {
    ...
    void VyRenderSystem::prepareSpotShadowPassRenderPass()
    {
        TVector<VkAttachmentDescription> attachments{};
        {
            // [ Color - 0 ] 
    ...
    void VyRenderSystem::prepareSpotShadowPassFramebuffers()
    {
    ...
    void VyRenderSystem::updateSpotShadowMaps(U32 lightIndex, VyFrameInfo frameInfo, GlobalUbo& globalUBO)
    {
        ShadowPassUBO sUbo;
    ...
    void VyRenderSystem::renderSpotShadowPass(VyFrameInfo frameInfo, GlobalUbo& globalUBO)
    {
        // PROFILE_FUNCTION();
