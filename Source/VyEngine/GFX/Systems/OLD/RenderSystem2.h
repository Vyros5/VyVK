...
namespace Vy
{
    ...
    public:
        ...
        VyRenderSystem2(const VyRenderSystem2&) = delete;
        VyRenderSystem2& operator=(const VyRenderSystem2&) = delete;
    ...
    private:
        ...
        CascadedDepthMap m_CascadedDepthMap;
        VkDescriptorSet  m_CascadedShadowMapDescSet;

        TextureArray    m_PointShadowCubeMaps{};
        VkDescriptorSet m_PointShadowMapDescSet;

        TextureArray    m_SpotShadowMaps{};
        VkDescriptorSet m_SpotShadowMapDescSet;
