...
// namespace Vy
// {
//     VyShaderReflection::VyShaderReflection(const TVector<U32>& spirvCode, VkShaderStageFlagBits stage) : 
//         m_ShaderStage{ stage }
//     {
...
//     void VyShaderReflection::ReflectEntryPoint(const spirv_cross::Compiler& compiler)
//     {
...
//     void VyShaderReflection::ReflectDescriptors(
//         const spirv_cross::Compiler&        compiler, 
//         const spirv_cross::ShaderResources& resources)
//     {
//         auto reflectResource = [&](
...
//             VkDescriptorType             descriptorType)
//         {
//             bool bHasBinding = compiler.has_decoration(resource.id, spv::DecorationBinding);

//             if(bHasBinding)
//             {
//                 bool bHasSetIdentifier = compiler.has_decoration(resource.id, spv::DecorationDescriptorSet);
//                 if(!bHasSetIdentifier)
//                 {
//                     TString type    = getDescriptorTypeName(descriptorType);
//                     U32     binding = compiler.get_decoration(resource.id, spv::DecorationBinding);

//                     std::cout 
//                         << "Warning: Resource " << resource.name 
//                         << " with binding: " << binding 
//                         << " and type " << type 
//                         << " does not explicitly specify a descriptor set." 
//                         << " The engine requires that the set corresponding to the same identifier of the host code be present in the shader." << "\n";
...
//     void VyShaderReflection::ReflectVertexInputs(
//         const spirv_cross::Compiler&        compiler, 
//         const spirv_cross::ShaderResources& resources)
//     {
...
//     void VyShaderReflection::ReflectOutputs(
//         const spirv_cross::Compiler&        compiler, 
//         const spirv_cross::ShaderResources& resources)
//     {
...
//             std::cout 
//                 << "Shader Output: " << output.Name
//                 << " (Location: " << output.Location
//                 << ", Format: " << getVkFormatName(output.Format) << ")" 
//                 << std::endl;
//         }
//     }


//     void VyShaderReflection::ReflectPushConstants(
//         const spirv_cross::Compiler&        compiler, 
//         const spirv_cross::ShaderResources& resources)
//     {
...
//     void VyShaderReflection::ReflectSpecializationConstants(const spirv_cross::Compiler& compiler)
//     {
...
//             std::cout 
//                 << "Specialization Constant: " << specConstant.Name
//                 << " (ID: " << specConstant.ID
//                 << ", Size: " << specConstant.Size << " bytes)" 
//                 << std::endl;
//         }
//     }

//     TString VyShaderReflection::ShaderResource::toString() const
//     {
...
//     VkFormat VyShaderReflection::SPIRTypeToVkFormat(const spirv_cross::SPIRType &type)
//     {
...
//     U32 VyShaderReflection::getFormatSize(VkFormat format)
//     {
//         switch (format)
//         {
...
//     TString VyShaderReflection::getShaderStageName(VkShaderStageFlagBits stage)
//     {
//         switch (stage)
//         {
...
//     TString VyShaderReflection::getDescriptorTypeName(VkDescriptorType type)
//     {
//         switch (type)
//         {
...
//     TString VyShaderReflection::getVkFormatName(VkFormat format)
//     {
//         switch (format)
//         {
...
//     U32 VyShaderReflection::getTotalDescriptorCountAcrossAllSets() const
//     {
//         size_t totalElements = std::accumulate(
//             m_DescriptorSets.begin(), m_DescriptorSets.end(), 0,
