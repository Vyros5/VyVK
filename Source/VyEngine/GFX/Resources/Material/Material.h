...
//         Shared<VyTexture> AlbedoMap;             // Base color texture          (sRGB)           Kd
...
//         Shared<VyTexture> AOMap;                 // Ambient occlusion texture   (linear)         Ka
//         Shared<VyTexture> EmissiveMap;           // Emissive texture            (sRGB)
//         Shared<VyTexture> SpecularGlossinessMap; // Specular Glossiness texture (RGB) + (A)      Ks
